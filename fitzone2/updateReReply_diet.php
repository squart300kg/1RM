...
<body>
  ...
  <?php include "top.php"; ?>
   ...
   <section class="breadcrumb breadcrumb_bg">
    ...
    $sql = "SELECT * FROM rereply_diet WHERE no = $rereply_no";
...
<div class = "container">
  <div class = "container">
    <form action="updateReReplyPro_diet.php" method="post">
      ...
      <input type="hidden" name="diet" value="<?php echo $board_category ?>">

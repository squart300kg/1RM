...
<body>
   ...
   <section class="breadcrumb breadcrumb_bg">
    ...
    $sql = "SELECT * FROM rereply_program WHERE no = $rereply_no";
...
<div class = "container">
  <div class = "container">
    <form action="updateReReplyPro_program.php" method="post">
      ...
      <input type="hidden" name="program" value="<?php echo $board_category ?>">
      <input type="hidden" name="board_no" value="<?php echo $board_no ?>">
      <input type="hidden" name="rereply_no" value="<?php echo $rereply_no ?>">

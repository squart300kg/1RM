...
<html>
	<head>
		...
		<script src="./templated-heavyindustry/js/skel.min.js?"></script>
		<script src="./templated-heavyindustry/js/skel-panels.min.js"></script>
		<script src="./templated-heavyindustry/js/init.js"></script>
		<noscript>
			<link rel="stylesheet" href="./templated-heavyindustry/css/skel-noscript.css" />
			<link rel="stylesheet" href="./templated-heavyindustry/css/style.css" />
			<link rel="stylesheet" href="./templated-heavyindustry/css/style-desktop.css" />
		</noscript>
	</head>
	<body class="homepage">
		<!-- Header -->

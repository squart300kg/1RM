  ...
  <?php include 'top.php'; ?>
   ...
   <section class="breadcrumb breadcrumb_bg">
    ...
    <?php
        ...
        $sql = "SELECT * FROM board_program WHERE category = '$program' AND no = $no";
        $result = mysqli_query($db, $sql);
        $row = mysqli_fetch_array($result);

        $sql_views_up = "UPDATE board_program SET views = views + 1 WHERE no = $no";
...
<div class = "container">
  <div class = "container">
    <form action="updateBoard_program.php" method="post">
      <div class = "box-body">
      ...
      if($nickname_db == $nickname_session){
        ...
        <form action="deleteBoardPro_program.php" method="post" id = "deleteBoardProForm" name = "deleteBoardProForm">
...
<div class = "container">
  <div class="comment-form">
    <form class="form-contact comment_form" method = "POST" action="insertReplyPro_program.php" id="commentForm">
      <div class="row">
        <div class="col-12">
           <div class="form-group">
...
<?php
$db = mysqli_connect("127.0.0.1", "root", "123456", "power");
$sql_reply = "SELECT * FROM reply_program WHERE board_no = $no AND board_category = '$program'";
      ...
      <div class="row">
         <div class="col-lg-8 posts-list">
          <div class="comments-area">
            <?php
            $sql_reply_count = "SELECT COUNT(*) FROM reply_program WHERE board_no = $no AND board_category = '$program'";
            ...
            $reply_count =  mysqli_fetch_array($result_reply_count);
             ...
             <div class="comment-list">
                      ...
                      <div class="desc">
                         ...
                         <div class="d-flex justify-content-between">
                            ...
                            if($nickname_db == $nickname_session){
                              ?>
                              <div class="reply-btn">
                                <form action="deleteReplyPro_program.php" method="post" id = "deleteReplyProForm_<?php echo "$row_reply_no" ?>" name = "deleteReplyProForm_<?php echo "$row_reply_no" ?>">
                                  <input type="hidden" id = "reply_no" name="reply_no" value="<?php echo $row_reply['no'] ?>">
                                  <input type="hidden" id = "board_category" name="board_category" value="<?php echo $program ?>">
                              ...
                              <div class="reply-btn">
                                <form action="updateReply_program.php" method="post">
                                  <input type="hidden" name="reply_no" value="<?php echo $row_reply['no'] ?>">
                                  <input type="hidden" name="board_category" value="<?php echo $program ?>">
                ...
                <form action="insertReReplyPro_program.php" style = "display : none; margin-top : 30px" id = "insertReReplyForm_<?php echo "$row_reply_no" ?>" method="post">
             ...
             $sql_rereply = "SELECT * FROM rereply_program WHERE reply_no = $reply_no";
                      ...
                      <div class="desc">
                         ...
                         <div class="d-flex justify-content-between">
                            ...
                            if($nickname_db == $nickname_session){
                              ?>
                              <div class="reply-btn">
                                <form action="deleteReReplyPro_program.php" method="post" name = "deleteReReplyProForm_<?php echo "$row_rereply_no" ?>" id = "deleteReReplyProForm_<?php echo "$row_rereply_no" ?>">
                                  <input type="hidden" id = "board_category" name="board_category" value="<?php echo $program ?>">
                                  <input type="hidden" id = "board_no" name="board_no" value="<?php echo $no ?>">
                              ...
                              <div class="reply-btn">
                                <form action="updateReReply_program.php" method="post">

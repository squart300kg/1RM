...
<body>
   ...
   <section class="breadcrumb breadcrumb_bg">
    ...
    $sql = "SELECT * FROM rereply_injury WHERE no = $rereply_no";
...
<div class = "container">
  <div class = "container">
    <form action="updateReReplyPro_injury.php" method="post">
      ...
      <input type="hidden" name="injury" value="<?php echo $board_category ?>">

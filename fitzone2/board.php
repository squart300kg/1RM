  ...
  <?php include 'top.php'; ?>
   ...
   <section class="breadcrumb breadcrumb_bg">
    ...
    <?php
        ...
        $sql = "SELECT * FROM board_bigmuscle7 WHERE category = '$bigMuscle' AND no = $no";
        $result = mysqli_query($db, $sql);
        $row = mysqli_fetch_array($result);

        $sql_views_up = "UPDATE board_bigmuscle7 SET views = views + 1 WHERE no = $no";
  ...
  <div class = "container">
    <form action="updateBoard.php" method="post">
      ...
      if($nickname_db == $nickname_session){
        ...
        <form action="deleteBoardPro.php" method="post" id = "deleteBoardProForm" name = "deleteBoardProForm">
        <input type="hidden" id = "bigMuscle7" name="bigMuscle7" value="<?php echo $bigMuscle ?>">
...
<div class = "container">
  <div class="comment-form">
    <form class="form-contact comment_form" method = "POST" action="insertReplyPro.php" id="commentForm">
      <div class="row">
        <div class="col-12">
           <div class="form-group">
...
<?php
$db = mysqli_connect("127.0.0.1", "root", "123456", "power");
$sql_reply = "SELECT * FROM reply_bigmuscle7 WHERE board_no = $no AND board_category = '$bigMuscle'";
      ...
      <div class="row">
         <div class="col-lg-8 posts-list">
          <div class="comments-area">
            <?php
            $sql_reply_count = "SELECT COUNT(*) FROM reply_bigmuscle7 WHERE board_no = $no AND board_category = '$bigMuscle'";
            ...
            $reply_count =  mysqli_fetch_array($result_reply_count);
             ...
             <div class="comment-list">
                      ...
                      <div class="desc">
                         ...
                         <div class="d-flex justify-content-between">
                            ...
                            if($nickname_db == $nickname_session){
                              ?>
                              <div class="reply-btn">
                                <form action="deleteReplyPro.php" method="post" id = "deleteReplyProForm_<?php echo "$row_reply_no" ?>" name = "deleteReplyProForm_<?php echo "$row_reply_no" ?>">
                                  <input type="hidden" id = "reply_no" name="reply_no" value="<?php echo $row_reply['no'] ?>">
                                  <input type="hidden" id = "board_category" name="board_category" value="<?php echo $bigMuscle ?>">
                              ...
                              <div class="reply-btn">
                                <form action="updateReply.php" method="post">
                                  ...
                                  <input type="hidden" name="board_category" value="<?php echo $bigMuscle ?>">
                ...
                <form action="insertReReplyPro.php" style = "display : none; margin-top : 30px" id = "insertReReplyForm_<?php echo "$row_reply_no" ?>" method="post">
             ...
             $sql_rereply = "SELECT * FROM rereply_bigmuscle7 WHERE reply_no = $reply_no";
                      ...
                      <div class="desc">
                         ...
                         <div class="d-flex justify-content-between">
                            ...
                            if($nickname_db == $nickname_session){
                              ?>
                              <div class="reply-btn">
                                <form action="deleteReReplyPro.php" method="post" name = "deleteReReplyProForm_<?php echo "$row_rereply_no" ?>" id = "deleteReReplyProForm_<?php echo "$row_rereply_no" ?>">
                                  <input type="hidden" id = "board_category" name="board_category" value="<?php echo $bigMuscle ?>">
                                  <input type="hidden" id = "board_no" name="board_no" value="<?php echo $no ?>">
                              ...
                              <div class="reply-btn">
                                <form action="updateReReply.php" method="post">

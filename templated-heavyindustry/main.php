	...
	<body class="homepage">
		...
		<div id="wrapper" class="container">
			...
			<div id="banner" class="row">
				<div class="12u">
					<section><a href="#"><img src="images/main_img.jpg" alt=""></a></section>
				</div>
			</div>
			...
			<div id="marketing" class="row">
				...
				<div class="3u">
					<section class="box">
						<h2>빅머슬 7</h2>
						<p class="subtitle">3대 600을 위한 필수운동</p>
						<ul class="style1">
						...
						<p><a href="bigMuscle7.php" class="button"><span>Read More</span></a></p>
					</section>
				</div>
				<div class="3u">
					<section class="box">
						<h2>부상과 싸워라</h2>
						<p class="subtitle">3대 600을 위한 부상 대처법</p>
						<ul class="style1">
							<li><a href="#">Donec dictum metus sapien</a></li>
							<li><a href="#">DonecInteger gravida urna</a></li>
							<li><a href="#">DonecEtiam posuere amet nisl</a></li>
				...
				<div class="3u">
					<section class="box">
						<h2>그리고 먹어라</h2>
						<p class="subtitle">3대 600을 위한 먹는법</p>
						<ul class="style1">
							<li><a href="#">Donec dictum metus sapien</a></li>
							<li><a href="#">DonecInteger gravida urna</a></li>
							<li><a href="#">DonecEtiam posuere amet nisl</a></li>
				...
				<div class="3u">
					<section class="box">
						<h2>자유 게시판</h2>
						<p class="subtitle">3대 600을 위한 정보공유</p>
						<ul class="style1">
							<li><a href="#">Donec dictum metus sapien</a></li>
							<li><a href="#">DonecInteger gravida urna</a></li>
							<li><a href="#">DonecEtiam posuere amet nisl</a></li>
